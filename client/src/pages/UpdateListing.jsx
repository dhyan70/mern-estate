...
const CreateListing = () => {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      ...
      const response = await axios.get(`http://localhost:3000/api/listing/getforupdate/${listingId}`);
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      const response = await axios.post(`http://localhost:3000/api/listing/update/${params.listingId}`, {
        ...formData,
